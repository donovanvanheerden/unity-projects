...
public class TextController : MonoBehaviour {
  ...
  public Text text;
	...
	private enum States { 
		...
		corridor_0, stairs_0, floor, closet_door, stairs_1, corridor_1, in_closet, corridor_2, stairs_2, corridor_3, courtyard 
	};
...
#region State Handler Methods
	void cell () {
		text.text = "You are in a prison cell, and you want to escape. There are some dirty " + 
								"sheets on the bed, a mirror on the wall, and the door is locked from " + 
								"the outside.\n\n" +
	...
	void lock_0 () {
		text.text = "This is one of those button locks. You have no idea what te combination is. " + 
								"You wish you could somehow see where the dirty fingerprints were, maybe " + 
								"that would help.\n\n" +
	...
	void cell_mirror () {
		text.text = "You are still in your cell, and you STILL want to escape! There are " + 
								"some dirty sheets on the bed, a mark where the mirror was, and that pesky " + 
								"door is still there, and firmly locked!\n\n" +
	...
	void lock_1 () {
		text.text = "You carefully put the mirror through the bars, and turn it round so you can " + 
								"see the lock. You can just make out fingerprints around the buttons. You press " + 
								"the dirty buttons, and hear a click.\n\n" +
	...
	void corridor_0 () {
		text.text = "You're out of your cell, but not out of trouble. You are in the corridor, there's a closet and some " +
								"stairs leading to the courtyard. There's also various detritus on the floor.\n\n" +
	...
	void stairs_0 () {
		text.text = "You start walking up the stairs towards the outside light. You realise it's not break time, " +
	...
	void closet_door () {
		text.text = "You are looking at a closet door, unfortunately it's locked. Maybe you could find something around " +
								"to help encourage it open?\n\n" +
	...
	void corridor_1 () {
		text.text = "Still in the corridor. Floor still dirty. Hairclip in hand. Now what? You wonder if that lock on " + 
								"the closet would succumb to some lock-picking?\n\n" +
	...
	void stairs_1 () {
		text.text = "Unfortunately weilding a puny hairclip hasn't given you the confidence to walk out into the courtyard " +
	...
	void in_closet () {
		text.text = "Inside the closet you see a cleaner's uniform that looks about your size! Seems like your day is " +
								"looking-up.\n\n" +
	...
	void stairs_2 () {
		text.text = "You feel smug for picking the closet door open, and are still armed with the hairclip (now badly bent). " +
								"Even these achievements together don't give you the courage to climb up the stairs to your death!\n\n" +
	...
	void corridor_3 () {
		text.text = "You're standing back in the corridor, now convincingly dressed as a cleaner. You strongly " +
								"consider the run for freedom.\n\n" +
	...
	void courtyard () {
		text.text = "You walk through the courtyard dressed as a cleaner. The guard tips his hat at you as you waltz past, " + 
								"claiming your freedom. Your heart races as you walk into the sunset.\n\n" +
